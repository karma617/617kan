	...
	<view class="serach">
		<view class="content" :style="{'border-radius':radius+'px'}">
			...
			<view class="content-box" :class="{'center':mode === 2}" @click="getFocus">
				...
				<input :placeholder="placeholder" @input="inputChange" confirm-type="search" @confirm="search" class="input" :class="{'center':!active && mode === 2}" :focus="isFocus" v-model="inputVal" @focus="focus" @blur="blur"/>
	...
	.content {
		...
		.content-box {
			...
			.icon {
				...
				&.icon-del {
					font-size: 40upx;
					&:before {content:"\e644";padding-right: 4upx;}
				}
